 ...
 * @description Behavioral coverage for the classic-script PDF merger the
 * share page's "print all" button builds its single print job with.
 */
...
describe("pdf merge", () => {
  ...
  it("keeps each source page's own size rather than normalising them", async () => {
    ...
    // that imposed one page size would silently reflow half the print job.
